    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.addFilterBefore(corsFilter(), UsernamePasswordAuthenticationFilter.class)
                ...
                .authorizeHttpRequests(request ->
                        ...
                        .requestMatchers("/courses/addNewCourse").hasAnyAuthority(Role.TEACHER.name(),Role.ADMIN.name())
                        .requestMatchers("/courses/deleteCourse").hasAnyAuthority(Role.TEACHER.name(),Role.ADMIN.name())
                        .requestMatchers("/courses/updateCourse").hasAnyAuthority(Role.TEACHER.name() , Role.STUDENT.name(),Role.ADMIN.name())
                        .requestMatchers("/students-courses/addNewStudentCourse").hasAnyAuthority(Role.TEACHER.name(),Role.ADMIN.name())
                        .requestMatchers("/weekly-programs/deleteWeeklyProgram").hasAnyAuthority(Role.TEACHER.name(),Role.ADMIN.name())
                        ...
                        .requestMatchers("/trial-exams/updateTrialExam").hasAnyAuthority(Role.TEACHER.name(),Role.ADMIN.name())
                                .requestMatchers("/trial-exams/updateTrialExamIsShownValue").hasAnyAuthority(Role.STUDENT.name(),Role.ADMIN.name())
                                .requestMatchers("/trial-exams/countUnshown").hasAnyAuthority(Role.STUDENT.name(),Role.ADMIN.name())
                        .requestMatchers("/trial-exams/deleteTrialExam").hasAnyAuthority(Role.TEACHER.name(),Role.ADMIN.name())
                                .requestMatchers("/meetings/countUnshown").hasAnyAuthority(Role.STUDENT.name(),Role.ADMIN.name())
                        ...
                        .requestMatchers("/lessons/sublessonNameDetails").hasAnyAuthority(Role.TEACHER.name(),Role.ADMIN.name())
                        .requestMatchers("/lessons/getAllLessons").hasAnyAuthority(Role.TEACHER.name(),Role.ADMIN.name())
                        .requestMatchers("/students-courses/unshownCourseNumber").hasAnyAuthority(Role.STUDENT.name(),Role.ADMIN.name())
                        .requestMatchers("/meetings/updateMeeting").hasAnyAuthority(Role.TEACHER.name(),Role.ADMIN.name())
